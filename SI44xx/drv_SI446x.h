...
const int SI4463_SDN_PIN = 8;
const int SI4463_IRQ_PIN = 9;
const int SPISCK = 13;

#define SI_SET_SDN_HIGH()   digitalWrite(SI4463_SDN_PIN, HIGH)
#define SI_SET_SDN_LOW()  digitalWrite(SI4463_SDN_PIN, LOW)   
#define SI_SET_CSN_HIGH() digitalWrite(slaveSelectPin, HIGH)
#define SI_SET_CSN_LOW()  digitalWrite(slaveSelectPin, LOW)
#define SI_GET_IRQ_STATUS() digitalRead(SI4463_IRQ_PIN)
